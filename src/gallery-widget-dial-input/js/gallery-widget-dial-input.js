    ...
    /* DialWidget class constructor */
    function DialWidget(config) {
        DialWidget.superclass.constructor.apply(this, arguments);
    }
     ...
     * used to populate the configuration for the DialWidget instance from markup already on the page.
     */
    DialWidget.HTML_PARSER = {
    ...
    DialWidget.MYNODE_TEMPLATE = "<div id={mynodeid}></div>";

    /* DialWidget extends the base Widget class */
    Y.extend(DialWidget, Y.Widget, {
        ...
        renderUI : function() {
             ...
             */
             ...
             // this._mynode = Node.create(Y.substitute(DialWidget.MYNODE_TEMPLATE, {mynodeid: this.get("id") + "_mynode"})); 
        },
        ...
        // Beyond this point is the DialWidget specific application and rendering logic
    ...
    Y.namespace("MyApp").DialWidget = DialWidget;
